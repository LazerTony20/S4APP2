...
----------------------------------------------------------------------------------
 ...
 signal s_i_ech3, s_i_ech4, s_i_ech5, s_i_ech6 : std_logic_vector (28 downto 0) := "00000000000000000000000000000";
 signal s_y_out29, s_o_param : std_logic_vector (7 downto 0) := "00000000";
...
if (i_reset = '1')  then
    ...
    s_i_ech2 <= "000000000000000000000000";
    s_i_ech5 <= "00000000000000000000000000000";
    s_i_ech4 <= "00000000000000000000000000000";
    s_i_ech3 <= "00000000000000000000000000000";
    s_y_out29 <= "00000000";
elsif (i_en = '1') then
    s_i_ech  <= i_ech;
end if;
