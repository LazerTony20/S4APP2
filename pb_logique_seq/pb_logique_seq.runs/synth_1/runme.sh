...
HD_PWD='C:/Users/antho/Documents/Programmes/S4APP2/pb_logique_seq/pb_logique_seq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Carre_24bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Carre_24bits.tcl
