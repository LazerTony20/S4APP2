...
proc create_hier_cell_M1_decodeur_i2s { parentCell nameHier } {
  ...
  connect_bd_net -net compteur_nbits_0_o_val_cpt [get_bd_pins MEF_decodeur_i2s/i_switch] [get_bd_pins compteur_7bits/o_val_cpt]
  ...
  connect_bd_net -net i_reset_1 [get_bd_pins i_reset] [get_bd_pins compteur_7bits/reset] [get_bd_pins registre_24bits_droite/i_reset] [get_bd_pins registre_24bits_gauche/i_reset] [get_bd_pins registre_decalage_24bits/i_reset]
  connect_bd_net -net mef_decod_i2s_v1b_0_o_bit_enable [get_bd_pins MEF_decodeur_i2s/o_reset] [get_bd_pins compteur_7bits/i_en] [get_bd_pins registre_decalage_24bits/i_en]
  ...
  connect_bd_net -net mef_decod_i2s_v1b_0_o_str_dat [get_bd_pins o_str_dat] [get_bd_pins MEF_decodeur_i2s/o_dat_strb]
